...
export function calculateAge(dateOfBirth: string): number {
    ...
    const birthDateComponents = getDateComponents(dateOfBirth);
    let age = today.getFullYear() - birthDateComponents.year;
    
    if (
      today.getMonth() + 1 < birthDateComponents.month || 
      (today.getMonth() + 1 === birthDateComponents.month && today.getDate() < birthDateComponents.day)
    ) {
      age--;
    }
